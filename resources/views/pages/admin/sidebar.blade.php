        ...
        <div class="kleon-vertical-nav">
            ...
            <div class="kleon-navmenu">
                ...
                <ul class="main-menu">
                    ...
                    <li class="menu-item menu-item-has-children {{ (Request::segment(2) == 'users') ? 'active' : ''}}"><a href="#"> <span class="nav-icon flex-shrink-0"><i class="bi bi-people fs-18"></i></span> <span class="nav-text">Employee</span></a>
                        <ul class="sub-menu">
                            @can('users-create')
