        ...
        <div class="inner-contents">
            ...
            <div class="card border-0 p-5">
                <div class="card-header pb-5 bg-transparent border-0 d-flex align-items-center justify-content-between gap-3">
                    <h4 class="mb-0">News Info</h4>
                </div>
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table id="newsList" class="display">
                            <thead>
                                <tr>
                                    <th>Title</th>
                                    <th>Image</th>
...
<script>
    $(function(){
        var dynamicParam = ["title","short_description","full_description"];
        $('#newsList').DataTable({
            processing: true,
            serverSide: true,
            ajax: {
                url: "{{ route('admin.news.datatables') }}",
                type: 'GET',
            },
            columns: [
                ...
                },
                {
                    ...
                    render:function(data, type, row, meta){
                        return CommonLib.truncateString(row.short_description,50);
                    }
                },
                {
                    data: 'id',
