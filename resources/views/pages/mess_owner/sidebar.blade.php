        ...
        <div class="kleon-vertical-nav">
            ...
            <div class="kleon-navmenu">
                ...
                <ul class="main-menu">
                    ...
                    <li class="menu-item"><a href="{{ route('mess_owner.menu.create') }}"> <span class="nav-icon flex-shrink-0"><i class="bi bi-speedometer fs-18"></i></span> <span class="nav-text">Our Menus</span></a></li>
