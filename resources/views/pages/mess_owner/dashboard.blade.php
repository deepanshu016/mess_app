@extends('pages.mess_owner.layout.layout')
    ...
    <div class="container-fluid">
        <div class="inner-contents">
            <div class="page-header d-flex align-items-center justify-content-between mr-bottom-30">
                <div class="left-part">
                    <h2 class="text-dark">Invoice Dashboard</h2>
                    <p class="text-gray mb-0">Lorem ipsum dolor sit amet </p>
                </div>
                <div class="right-part">
                    <a href="{{ asset('/') }}frontend/assets/img/kleon-invoice.pdf" class="btn btn-primary rounded-2 ff-heading fs-18 fw-bold py-4" download><i class="bi bi-pie-chart-fill me-1"></i> Download Report</a>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-6">
                            <div class="card border-0 shadow-sm pd-top-40 pd-bottom-40">
                                <div class="card-body py-0">
                                    <h4 class="mb-3">Invoice Sent</h4>
                                    <h2 class="fs-38 d-flex align-items-center gap-4"> 421 <div class="badge bg-success fs-16"><i class="bi bi-graph-up-arrow me-2"></i> 0.5%</div></h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col col-lg-6">
                            <div class="card border-0 shadow-sm pd-top-40 pd-bottom-40">
                                <div class="card-body py-0">
                                    <h4 class="mb-3">Invoice Completed</h4>
                                    <h2 class="fs-38 d-flex align-items-center gap-4"> 874 <div class="badge bg-danger fs-16"><i class="bi bi-graph-down-arrow me-2"></i> -6.4%</div></h2>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card border-0 shadow-sm p-5">
                                <div class="card-body p-0 d-flex align-items-center justify-content-between gap-5 flex-wrap flex-xl-nowrap">
                                    <div class="flex-shrink-0">
                                        <h4 class="mb-3">Total Clients</h4>
                                        <h2 class="fs-38 d-flex align-items-center gap-4"> 68 <div class="text-success fs-16"><i class="bi bi-caret-up-fill"></i> 0.5%</div></h2>
                                    </div>
                                    <div id="chart-46"></div>
                                </div>
                            </div>
                        ...
                        <div class="col col-lg-6">
                            <div class="card border-0 shadow-sm pd-top-40 pd-bottom-40">
                                <div class="card-body py-0">
                                    <h4 class="mb-3">Invoice Remaining</h4>
                                    <div class="d-flex align-items-center gap-3 mt-3">
                                        <div class="flex-grow-1">
                                            <div class="progress rounded-1 bg-light-200 mb-2" role="progressbar" aria-valuemin="0" aria-valuemax="100" style="height: 10px;">
                                                <div class="progress-bar bg-primary bg-gradient rounded-1" style="width: 24%"></div>
                                            </div>
                                            <p class="text-gray mb-0"><span class="text-danger fw-bold">-0.8%</span> from last month</p>
                                        </div>
                                        <h2 class="fs-38"> 24</h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between gap-4 flex-wrap p-0 pt-5 mt-6">
                                        <div>
                                            ...
                                            <p class="fs-14 text-gray mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna</p>
                                        </div>

                                        <div class="btn-group flex-shrink-0">
                                            <a href="inbox.html" class="btn bg-soft-success btn-outline-success rounded-2 ff-heading fs-18 fw-bold lh-24 py-3"> Learn More</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-6 col-lg-12">
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="{{ asset('/') }}frontend/assets/img/clients/1.jpg" alt="img">
                                                    </div>
                                                    <div>
                                            ...
                                            <td>
                                                <div class="dropdown text-end">
                                                    ...
                                                    <div class="dropdown-menu p-0">
                                                        ...
                                                        <a class="dropdown-item" href="{{ asset('/') }}frontend/assets/img/kleon-invoice.pdf" download><i class="bi bi-download"></i></a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="{{ asset('/') }}frontend/assets/img/clients/2.jpg" alt="img">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="{{ asset('/') }}frontend/assets/img/clients/3.jpg" alt="img">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="{{ asset('/') }}frontend/assets/img/clients/4.jpg" alt="img">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex gap-2 flex-wrap">
                                                    <div class="profilepicture flex-shrink-0 d-none d-xl-block">
                                                        <img src="{{ asset('/') }}frontend/assets/img/clients/5.jpg" alt="img">
                                                    </div>
                                                    <div>
                    ...
                    <div class="card border-0 shadow-sm">
                        ...
                        <div class="card-body d-flex align-items-center gap-3 flex-wrap">
                            ...
                            <div class="flex-shrink-0">
                                <h2 class="d-flex align-items-center gap-2 mb-2"> 49 <i class="bi bi-arrow-up-circle-fill fs-26 text-success ms-1"></i></h2>
                                <h5 class="fw-semibold lh-24 mb-0">Total Task Closed</h5>
                                <h5 class="fw-semibold text-gray mb-0"><span class="text-success fw-bold">+5.4%</span> than last day</h5>
                            </div>
                        </div>
                    </div>
                </div>
